...
@Composable
fun PythonLinks(navController: NavController) {
    ...
    Box(modifier = Modifier
        ...
        Column(modifier= Modifier.fillMaxWidth()) {
            Row(modifier = Modifier
                ...
                Text(text = "Python", fontSize = 25.sp, fontWeight = FontWeight.Bold ,color = Color.White, textAlign = TextAlign.Center, modifier = Modifier.fillMaxWidth())
            }
            Row(modifier = Modifier
                .fillMaxWidth()
                .padding(top = 6.dp)) {
                Button(onClick = {
                    val urlIntent = Intent(
                        Intent.ACTION_VIEW,
                        Uri.parse("https://youtube.com/playlist?list=PLsyeobzWxl7poL9JTVyndKe62ieoN-MZ3")
                    )
