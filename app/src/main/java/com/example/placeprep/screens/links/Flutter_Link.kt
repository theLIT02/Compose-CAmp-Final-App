...
@Composable
fun FlutterLink(navController: NavController) {
    ...
    Box(modifier = Modifier
        ...
        Column(modifier= Modifier.fillMaxWidth()) {
            Row(modifier = Modifier
                ...
                Text(text = "Data Structure", fontSize = 25.sp, fontWeight = FontWeight.Bold ,color = Color.White, textAlign = TextAlign.Center, modifier = Modifier.fillMaxWidth())
            }
            Row(modifier = Modifier
                .fillMaxWidth()
                .padding(top = 6.dp)) {
                Button(onClick = {
                    val urlIntent = Intent(
                        Intent.ACTION_VIEW,
                        Uri.parse("https://youtube.com/playlist?list=PL4cUxeGkcC9jLYyp2Aoh6hcWuxFDX6PBJ")
                    )
