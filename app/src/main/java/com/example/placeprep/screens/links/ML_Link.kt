...
@Composable
fun MLLink(navController: NavController) {
    ...
    Box(modifier = Modifier
        ...
        Column(modifier= Modifier.fillMaxWidth()) {
            Row(modifier = Modifier
                ...
                Text(text = "Machine Learning", fontSize = 25.sp, fontWeight = FontWeight.Bold ,color = Color.White, textAlign = TextAlign.Center, modifier = Modifier.fillMaxWidth())
            }
            Row(modifier = Modifier
                .fillMaxWidth()
                .padding(top = 6.dp)) {
                Button(onClick = {
                    val urlIntent = Intent(
                        Intent.ACTION_VIEW,
                        Uri.parse("https://youtube.com/playlist?list=PLZoTAELRMXVPBTrWtJkn3wWQxZkmTXGwe")
                    )
